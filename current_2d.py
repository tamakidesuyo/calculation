...
for j in range(0,t_num+1):
    ...
    for i in f_preset:
        if re.search('#',i):
            ...
            d_preset += [i.split()]
        elif k >= Lx*Ly and k <= (Lx-1)*Ly + (Ly-1)*Lx:
            d_preset += [i.split()]
        elif k > (Lx-1)*Ly + (Ly-1)*Lx and k <= (Lx-1)*Ly + (Ly-1)*Lx + Ly:
            d_preset += [i.split()]   #b.c.をperiodicにした時のx方向のホッピングのデータの取り出し 
        else:
            pass
        k += 1
    ...
    for i in f_phys1:
        if re.search('#',i):
            ...
            d_phys1 += [i.split()]   #b.c.をperiodicにした時のx方向のホッピングのデータの取り出し 
        else:
            pass
        k += 1
    ...
    for i in f_phys2:
        if re.search('#',i):
            ...
            d_phys2 += [i.split()]   #b.c.をperiodicにした時のx方向のホッピングのデータの取り出し 
        else:
            pass
        k += 1
    ...
    for i in f_phys3:
        if re.search('#',i):
            ...
            d_phys3 += [i.split()]   #b.c.をperiodicにした時のx方向のホッピングのデータの取り出し 
        else:
            pass
        k += 1
    ...
    for i in f_phys4:
        if re.search('#',i):
            ...
            d_phys4 += [i.split()]   #b.c.をperiodicにした時のx方向のホッピングのデータの取り出し 
        else:
            pass
        k += 1
